...
{
    public partial class db_a75dc8_gravityContext : DbContext
    {
        //public static string GetConnectionString()
        //{
        //    return Startup.ConnectionString;
        //}
        public db_a75dc8_gravityContext()
        {
        }

        public db_a75dc8_gravityContext(DbContextOptions<db_a75dc8_gravityContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("Data Source=SQL5101.site4now.net;Database=db_a75dc8_gravity;Initial Catalog=db_a75dc8_gravity;User Id=db_a75dc8_gravity_admin;Password=Abhishek@7;Persist Security Info=False;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Connection Timeout=30;");
//            }
//        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblEmployee>(entity =>
            {
                entity.HasKey(e => e.Sno)
                    .HasName("PK__Tbl_Empl__CA1FE464397D3004");
